...
trait UploadFile
{
	...
	// figuro consultar a la IA para esta parte que mo me funcionaba :(
	private function uploadFile($model, $request)
	{
		...
		$imageName = "{$random}.{$uploadedFile->clientExtension()}";

		$uploadedFile->move(storage_path("app/public/{$path}"), $imageName);
